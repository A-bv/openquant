...
Two jobs:
  1. Pin the multi-asset covariance engine against the EPFL Sample Exam 2
     answer key (P4) — the same oracle that already governs `core/utils` and
     `core/wacc`. The 2-asset reduction must reproduce the exam's worked values.
...
from core.common import min_variance_two_asset_weight
