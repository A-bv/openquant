...
// Standard definitions used across the app — single source of truth.
export const DEFS = {
  ...
  CAPM: 'Capital Asset Pricing Model — the EPFL formula rE = rf + β × MRP. Maps a stock\'s risk (β) into the return investors should demand.',
