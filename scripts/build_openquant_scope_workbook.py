...
FORMULA_ROWS = [
    ...
    ("Statistics", "Standard deviation", "SD(R) = sqrt(Var(R))", "Yes", "Yes", "Yes", "Yes", "No", "No", "Later", "Volatility annualisation exists in core.utils; no standalone probability-law module"),
