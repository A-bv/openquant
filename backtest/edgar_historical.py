...
Wraps `core.data.EDGARClient` — does not re-implement HTTP or auth.
"""
...
# resolve cleanly. Do not modify core/data.py — keep production unchanged.
...
def fetch_statements_as_of(
    ...
    # Align all series to revenue's last-10-years index, just like core/data.py
