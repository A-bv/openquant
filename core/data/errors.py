...
The failure modes of the data layer, pulled out of ``core/data/data.py`` so
they can be imported and tested on their own. Re-exported by ``core.data`` for
backward compatibility, so existing ``from core.data import DataFetchError``
